"""
Unit tests for dec_int_positive_integer_const_size_big_endian, enc_int_positive_integer_const_size_big_endian

Implement tests for the following methods:
  - dec_int_positive_integer_const_size_big_endian
  - enc_int_positive_integer_const_size_big_endian
"""
import random
...
def _encode_and_decode_single_positive_integer(acn_encoder: ACNEncoder, input_number: int, bit: int) -> tuple[
    ...
    """
    encoded_res = acn_encoder.enc_int_positive_integer_const_size_big_endian(input_number, bit)
    if not encoded_res.success:
        return False, 0
    assert encoded_res.bits_encoded == bit

    acn_decoder: ACNDecoder = acn_encoder.get_decoder()
    decoded_res = acn_decoder.dec_int_positive_integer_const_size_big_endian(bit)
...
def test_enc_dec_int_positive_integer_const_size_big_endian_single_value(acn_encoder: ACNEncoder, seed: int, byte: int) -> None:
    input_number: int = get_random_unsigned(byte * 8)
    _test_single_positive_integer(acn_encoder, input_number, byte * 8)


def test_enc_dec_int_positive_integer_const_size_big_endian_multiple_values(acn_encoder: ACNEncoder, seed: int, byte: int) -> None:
...
def test_enc_dec_int_positive_integer_const_size_big_endian_zero(acn_encoder: ACNEncoder, seed: int, byte: int) -> None:
    input_number: int = 0
    _test_single_positive_integer(acn_encoder, input_number, byte * 8)


def test_enc_dec_int_positive_integer_const_size_big_endian_max_value(acn_encoder: ACNEncoder, seed: int, byte: int) -> None:
    input_number: int = get_unsigned_max(byte * 8)
    _test_single_positive_integer(acn_encoder, input_number, byte * 8)


def test_enc_dec_int_positive_integer_const_size_big_endian_exceed_max_value(acn_encoder: ACNEncoder, seed: int, byte: int) -> None:
    input_number: int = get_unsigned_max(byte * 8) + 1
    encoded_res = acn_encoder.enc_int_positive_integer_const_size_big_endian(input_number, byte * 8)
