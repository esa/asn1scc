...
def _encode_and_decode_single_bcd(acn_encoder: ACNEncoder, input_number: int, nibble: int) -> tuple[bool, int]:
...
def _encode_and_decode_multiple_bcd(acn_encoder: ACNEncoder, input_numbers: list[int], nibble: int) -> tuple[bool, list[int]]:
...
def _test_single_bcd_value(acn_encoder: ACNEncoder, input_number: int, nibble: int) -> None:
    ...
    success, decoded_value = _encode_and_decode_single_bcd(acn_encoder, input_number, nibble)
...
def _test_multiple_bcd_values(acn_encoder: ACNEncoder, input_numbers: list[int], nibble: int) -> None:
    ...
    success, decoded_values = _encode_and_decode_multiple_bcd(acn_encoder, input_numbers, nibble)
