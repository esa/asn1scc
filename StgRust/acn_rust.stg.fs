...
let octet_string_containing_deferred_func (p:string) (sFuncName:string) (sDetParamName:string) (sPatchFuncName:string) (soMF:string option) (soMFM:string option) (sErrCode:string) codec =
    ST.lang <- CommonTypes.ProgrammingLanguage.Ada; ST.double2StringPlain <- true
    match codec with
    | Encode    ->
        ST.call "acn_rust" "octet_string_containing_deferred_func_encode" [("p",p :>Object);("sFuncName",(if sFuncName = null then null else ST.StrHelper sFuncName:>Object) );("sDetParamName",(if sDetParamName = null then null else ST.StrHelper sDetParamName:>Object) );("sPatchFuncName",(if sPatchFuncName = null then null else ST.StrHelper sPatchFuncName:>Object) );("soMF",(if soMF.IsNone then null else ST.StrHelper soMF.Value:>Object) );("soMFM",(if soMFM.IsNone then null else ST.StrHelper soMFM.Value:>Object) );("sErrCode",(if sErrCode = null then null else ST.StrHelper sErrCode:>Object) )]
    | Decode    ->
        ST.call "acn_rust" "octet_string_containing_deferred_func_decode" [("p",p :>Object);("sFuncName",(if sFuncName = null then null else ST.StrHelper sFuncName:>Object) );("sDetParamName",(if sDetParamName = null then null else ST.StrHelper sDetParamName:>Object) );("sPatchFuncName",(if sPatchFuncName = null then null else ST.StrHelper sPatchFuncName:>Object) );("soMF",(if soMF.IsNone then null else ST.StrHelper soMF.Value:>Object) );("soMFM",(if soMFM.IsNone then null else ST.StrHelper soMFM.Value:>Object) );("sErrCode",(if sErrCode = null then null else ST.StrHelper sErrCode:>Object) )]
...
let octet_string_containing_deferred_wrapper (sBody:string) (sDetParamName:string) (sPatchFuncName:string) (soMF:string option) (soMFM:string option) (sErrCode:string) codec =
    ST.lang <- CommonTypes.ProgrammingLanguage.Ada; ST.double2StringPlain <- true
    match codec with
    | Encode    ->
    ...
    | Decode    ->
        ST.call "acn_rust" "octet_string_containing_deferred_wrapper_decode" [("sBody",(if sBody = null then null else ST.StrHelper sBody:>Object) );("sDetParamName",(if sDetParamName = null then null else ST.StrHelper sDetParamName:>Object) );("sPatchFuncName",(if sPatchFuncName = null then null else ST.StrHelper sPatchFuncName:>Object) );("soMF",(if soMF.IsNone then null else ST.StrHelper soMF.Value:>Object) );("soMFM",(if soMFM.IsNone then null else ST.StrHelper soMFM.Value:>Object) );("sErrCode",(if sErrCode = null then null else ST.StrHelper sErrCode:>Object) )]
