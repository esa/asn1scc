...
let private mergeEnumerated (asn1: Asn1Ast.AstRoot) (lms:(ProgrammingLanguage*LanguageMacros) list) (items: Asn1Ast.NamedItem list) (originalLocation: SrcLoc option, loc: SrcLoc)
    ...
    let mapItem (i:int) (itm:Asn1Ast.NamedItem) =
        ...
        let c_name, s_name, p_name, a_name, r_name =
            ...
            | AlwaysPrefixTypeName      ->
                ...
                c_tpname + "_" + itm.c_name, s_tpname + "_" + itm.scala_name, p_tpname + "_" + itm.python_name, a_tpname + "_" + itm.ada_name, r_tpname + "_" + itm.rust_name
            | _     ->
                asn1.args.TypePrefix + itm.c_name, asn1.args.TypePrefix + itm.scala_name, asn1.args.TypePrefix + itm.python_name, asn1.args.TypePrefix + itm.ada_name, asn1.args.TypePrefix + itm.rust_name

        match acnType with
        | None  ->
            let acnEncodeValue = (BigInteger i)
            {NamedItem.Name = itm.Name; Comments = itm.Comments; c_name = c_name; scala_name = s_name; python_name = p_name; ada_name = a_name; rust_name = r_name; definitionValue = definitionValue; acnEncodeValue = acnEncodeValue}
        | Some acnType ->
            let acnEncodeValue =
                match tryGetProp props (fun x -> match x with ENCODE_VALUES -> Some true | _ -> None) with
                | Some _    ->
        ...
        | Asn1Ast.Sequence children ->
            ...
            let mergeChild (cc:ChildSpec option) (c:Asn1Ast.ChildInfo) (us:Asn1AcnMergeState)  =
                ...
                | None      ->
                    ...
                    Asn1Child ({Asn1Child.Name = c.Name; _c_name = c.c_name; _scala_name = c.scala_name; _python_name = c.python_name; _ada_name = c.ada_name; _rust_name = c.rust_name; Type = newChild; Optionality = newOptionality; asn1Comments = c.Comments |> Seq.toList; acnComments=[]}), us1
                | Some cc   ->
                    ...
                    | None  ->
                        ...
                        Asn1Child ({Asn1Child.Name = c.Name; _c_name = c.c_name; _scala_name = c.scala_name; _python_name = c.python_name; _ada_name = c.ada_name; _rust_name = c.rust_name; Type = newChild; Optionality = newOptionality; asn1Comments = c.Comments |> Seq.toList; acnComments = cc.comments}), us1
                    | Some xx  ->
        ...
        | Asn1Ast.Choice children ->
            ...
            let mergeChild (cc:ChildSpec option) (c:Asn1Ast.ChildInfo) (us:Asn1AcnMergeState) =
                ...
                | None      ->
                    ...
                    {ChChildInfo.Name = c.Name; _c_name = c.c_name; _scala_name = c.scala_name; _python_name = c.python_name; _ada_name = c.ada_name; _rust_name = c.rust_name; Type = newChild; acnPresentWhenConditions = acnPresentWhenConditions; asn1Comments = c.Comments|> Seq.toList; acnComments = []; present_when_name = present_when_name; Optionality = newOptionality}, us1
                | Some cc   ->
                    let enumClassName =
