...
let createReferenceTypeFunction2 (r:Asn1AcnAst.AstRoot) (l:LanguageMacros) (t:Asn1AcnAst.Asn1Type) (o:Asn1AcnAst.ReferenceType) (typeDefinition:TypeDefinitionOrReference)  (us:State)  =
    let callBaseTypeFunc = l.isvalid.call_base_type_func
    let vcbs,us = [], us
