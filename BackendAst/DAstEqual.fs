...
let createReferenceTypeEqualFunction2 (r:Asn1AcnAst.AstRoot) (lm:LanguageMacros) (t:Asn1AcnAst.Asn1Type) (o:Asn1AcnAst.ReferenceType)  (defOrRef:TypeDefinitionOrReference)  =
    //let isEqualFuncName     = getEqualFuncName r l lm t.id
    let isEqualFuncName            = getFuncName r lm  defOrRef
    let typeDefinitionName = lm.lg.getLongTypedefName defOrRef
